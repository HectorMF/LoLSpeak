...
public class GameInfoTabbed extends Activity implements ActionBar.TabListener, ChampionListFragment.OnFragmentInteractionListener, ItemListFragment.OnFragmentInteractionListener, SummonerSpellFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_info_tabbed);
    ...
    @Override
    public void onFragmentInteraction(String hi)
    {}
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.game_info_tabbed, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return getString(R.string.title_championsTab).toUpperCase(l);
                case 1:
                    return getString(R.string.title_itemsTab).toUpperCase(l);
                case 2:
                    return getString(R.string.title_summonerGameInfoTab).toUpperCase(l);
            }
            return null;
        }
    }
